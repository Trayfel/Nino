...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the Nino Support Server\'s feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love Nino!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Support Server](https://discord.gg/uKYmSDG9yS) to further discuss your feedback.
      `) 

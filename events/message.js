  ...
  if (prefixRegex.test(message.content)) {
    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Nino. Need help?')
        .setThumbnail('')
        .setDescription(`You can see everything I can do by using the \`${prefix}help\` command.`)
        .addField('Invite Me', oneLine`
          You can add me to your server by clicking [here](https://discord.com/api/oauth2/authorize?client_id=1009002446913286266&permissions=8&scope=bot)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the [Nino Support Server](https://discord.gg/uKYmSDG9yS)!
        `)
        .setFooter('DM Past#0001 to speak directly with the Developer!')
